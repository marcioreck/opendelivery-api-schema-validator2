...
class ValidationEngine {
    ...
    compileOpenAPISchema(schema) {
        ...
        if (schema.openapi && schema.components?.schemas) {
            ...
            try {
                return this.ajv.compile(orderSchema);
            }
            catch (error) {
    ...
    resolveReferences(schema, allSchemas) {
    ...
    validateSecurityRequirements(payload) {
        const errors = [];
    ...
    checkSensitiveData(obj, path, errors) {
